...
(cl:defmethod cl:initialize-instance :after ((m <TwistGripper>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TwistGripper)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name teng_arduino-msg:<TwistGripper> is deprecated: use teng_arduino-msg:TwistGripper instead.")))
...
(cl:defmethod twist-val ((m <TwistGripper>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader teng_arduino-msg:twist-val is deprecated.  Use teng_arduino-msg:twist instead.")
  (twist m))

(cl:ensure-generic-function 'gripper-val :lambda-list '(m))
(cl:defmethod gripper-val ((m <TwistGripper>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader teng_arduino-msg:gripper-val is deprecated.  Use teng_arduino-msg:gripper instead.")
  (gripper m))
