...
(cl:defmethod cl:initialize-instance :after ((m <PoseAction>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PoseAction)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name action_infer-msg:<PoseAction> is deprecated: use action_infer-msg:PoseAction instead.")))

(cl:ensure-generic-function 'pose_data-val :lambda-list '(m))
(cl:defmethod pose_data-val ((m <PoseAction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader action_infer-msg:pose_data-val is deprecated.  Use action_infer-msg:pose_data instead.")
  (pose_data m))

(cl:ensure-generic-function 'action_data-val :lambda-list '(m))
(cl:defmethod action_data-val ((m <PoseAction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader action_infer-msg:action_data-val is deprecated.  Use action_infer-msg:action_data instead.")
  (action_data m))
