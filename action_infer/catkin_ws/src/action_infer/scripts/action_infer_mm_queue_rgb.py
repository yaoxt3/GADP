...
dir = '/home/yxt/thesis/yirui/imitation/3D-Diffusion-Policy/3D-Diffusion-Policy/data/outputs/pick_place-0209-simple_dp3_mm-8000-datav123-rgb'
...
class ActionInfer:
    ...
    def __init__(self, cfg: OmegaConf):
        ...
        self.rgb_sub = rospy.Subscriber('/rgb/image_raw', Image, self.rgb_callback, queue_size=1)
        ...
        self.traj_output_dir = '/home/yxt/thesis/yirui/catkin_ws/experiment_imgs/0.0625_cube'
    ...
    def rgb_callback(self, msg):
        ...
        self.cimg_queue.enqueue(rgb_image)
    ...
    def get_next_file_index(self):
        pattern = re.compile(rf'recorded_traj(\d+)gripper{self.end_effector_length}nogstar\.pkl')
    ...
    def save_graph(self):
        ...
        graph_output_path = os.path.join(self.traj_output_dir, f'height_time_graph{self.file_index}nogstar.png')
        print(f"Saving traj graph to {graph_output_path}")
        plt.savefig(graph_output_path)
        plt.close()
    
    def save_traj(self):
        traj_output_path = os.path.join(self.traj_output_dir, f'recorded_traj{self.file_index}gripper{self.end_effector_length}nogstar.pkl')
